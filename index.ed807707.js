...
})({"ciZNZ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3005c26bed807707";
"use strict";
...
},{}],"ePRIk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _cookie = require("../token/cookie");
var _querySelectors = require("../query-selectors");
var _scrollAuto = require("../popup/scroll-auto");
var _dateFns = require("date-fns");
var _jsCookie = require("js-cookie");
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
var _renderMessages = require("../messages/render-messages");
var _historyMessage = require("../messages/history-message");
var _templateContent = require("../template-content");
const { formInput, form, ul } = (0, _querySelectors.querySelectors);
const socket = new WebSocket(`wss://edu.strada.one/websockets?${(0, _cookie.getToken)()}`);
socket.onopen = ()=>{
    (0, _renderMessages.renderMessages)();
};
...
socket.onmessage = (e)=>{
    ...
    const templateContent = (0, _templateContent.getTemplateContent)();
    const timeMessages = (0, _dateFns.format)(new Date(dataParse.createdAt), "HH:mm");
    if (templateContent.messageInner && templateContent.messageText && templateContent.messageUser && templateContent.messageTime) {
        if (dataParse.user.email === (0, _jsCookieDefault.default).get("email")) {
    ...
    (0, _scrollAuto.scrollLastElem)();
    (0, _historyMessage.handelMessageHistory)();
};
...
},{"../token/cookie":"deMq3","../query-selectors":"fP9pM","../popup/scroll-auto":"iq8Iq","date-fns":"dU215","js-cookie":"c8bBu","../messages/render-messages":"hzi03","../messages/history-message":"7B31b","../template-content":"khQ8k","@parcel/transformer-js/src/esmodule-helpers.js":"3xDVK"}],"deMq3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getToken", ()=>getToken);
parcelHelpers.export(exports, "cookieSubmit", ()=>cookieSubmit);
var _querySelectors = require("../query-selectors");
var _jsCookie = require("js-cookie");
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
var _checkToken = require("./check-token");
const { confirmationForm } = (0, _querySelectors.querySelectors);
function getToken() {
    return (0, _jsCookieDefault.default).get("token");
}
function cookieSubmit() {
    confirmationForm?.addEventListener("submit", (event)=>{
        event.preventDefault();
        (0, _checkToken.handlerTokenInput)();
    });
}

},{"../query-selectors":"fP9pM","js-cookie":"c8bBu","./check-token":"7gxfl","@parcel/transformer-js/src/esmodule-helpers.js":"3xDVK"}],"fP9pM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const querySelectors = {
    ...
    ul: document.querySelector(".message__list"),
    template: document.querySelector("#element-li"),
    confirmationInput: document.querySelector(".modal__confirmation-input"),
    confirmationForm: document.querySelector(".modal__confirmation-form-inner"),
    modalInputSettings: document.querySelector(".form__modal-input"),
    modal: document.querySelector(".modal__authorization"),
    enterBtn: document.querySelector(".modal__authorization__enter"),
    modalEntry: document.querySelector(".modal__confirmation"),
    closeBtnModal: document.querySelector(".modal__confirmation__close"),
    modalForm: document.querySelector(".form__modal"),
    authorizationInput: document.querySelector(".modal__authorization-input"),
    authorizationInputForm: document.querySelector(".modal__authorization-form-inner"),
    btnModal: document.querySelector(".btn__settings"),
    myModal: document.querySelector(".modal"),
    modalExit: document.querySelector(".modal__box-btn"),
    userBtn: document.querySelector(".box__users-btn"),
    userBox: document.querySelector(".box__users"),
    amountUsers: document.querySelector(".amount__users-num"),
    btn__exit: document.querySelector(".btn__exit")
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"3xDVK"}],"7gxfl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handlerTokenInput", ()=>handlerTokenInput);
var _querySelectors = require("../query-selectors");
var _renderMessages = require("../messages/render-messages");
var _jsCookie = require("js-cookie");
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
var _dataUrl = require("../data-url");
var _historyMessage = require("../messages/history-message");
const { confirmationInput, modal, modalEntry, confirmationForm } = (0, _querySelectors.querySelectors);
async function entryUser() {
    const inputValue = confirmationInput?.value;
    const response = await fetch((0, _dataUrl.URL_USER_ME_DATA), {
        method: "GET",
        headers: {
...
async function handlerTokenInput() {
    ...
    if (response.ok) {
        ...
        const inputValue = confirmationInput?.value;
        (0, _jsCookieDefault.default).set("token", inputValue);
        (0, _jsCookieDefault.default).set("name", data.name);
        (0, _jsCookieDefault.default).set("email", data.email);
        console.log(data);
        modal?.close();
        modalEntry?.close();
        (0, _historyMessage.getMessageHistory)();
        (0, _historyMessage.handelMessageHistory)();
        (0, _renderMessages.renderMessages)();
    } else {
...
},{"../query-selectors":"fP9pM","../messages/render-messages":"hzi03","js-cookie":"c8bBu","../data-url":"hqdS9","../messages/history-message":"7B31b","@parcel/transformer-js/src/esmodule-helpers.js":"3xDVK"}],"hzi03":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
var _templateContent = require("../template-content");
const { ul } = (0, _querySelectors.querySelectors);
let writingArr = [
    0,
    20
];
function renderMessages() {
    ...
    objMessagesSlice.forEach((element)=>{
        const templateContent = (0, _templateContent.getTemplateContent)();
        const timeMessages = (0, _dateFns.format)(new Date(element.updatedAt), "HH:mm");
        if (templateContent.messageInner && templateContent.messageText && templateContent.messageUser && templateContent.messageTime) {
            if (element.user.email === (0, _jsCookieDefault.default).get("email") && templateContent.messageInner) {
                templateContent.messageInner.classList.add("user__inner");
                templateContent.messageFrom.classList.add("user");
            ...
            if (ul) ul.prepend(templateContent.li);
        }
    });
...
},{"../query-selectors":"fP9pM","date-fns":"dU215","js-cookie":"c8bBu","../template-content":"khQ8k","@parcel/transformer-js/src/esmodule-helpers.js":"3xDVK"}],"dU215":[function(require,module,exports) {
"use strict";
...
},{"387b0aecfe84b867":"1vXXw"}],"khQ8k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getTemplateContent", ()=>getTemplateContent);
var _querySelectors = require("./query-selectors");
const { template } = (0, _querySelectors.querySelectors);
...
},{"./query-selectors":"fP9pM","@parcel/transformer-js/src/esmodule-helpers.js":"3xDVK"}],"hqdS9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "URL_USER_DATA", ()=>URL_USER_DATA);
parcelHelpers.export(exports, "URL_MESSAGE_DATA", ()=>URL_MESSAGE_DATA);
parcelHelpers.export(exports, "URL_USER_ME_DATA", ()=>URL_USER_ME_DATA);
const URL_USER_DATA = "https://edu.strada.one/api/user";
const URL_USER_ME_DATA = "https://edu.strada.one/api/user/me";
const URL_MESSAGE_DATA = "https://edu.strada.one/api/messages/";

},{"@parcel/transformer-js/src/esmodule-helpers.js":"3xDVK"}],"7B31b":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handelMessageHistory", ()=>handelMessageHistory);
parcelHelpers.export(exports, "getMessageHistory", ()=>getMessageHistory);
var _cookie = require("../token/cookie");
var _dataUrl = require("../data-url");
async function getMessageHistory() {
    const response = await fetch((0, _dataUrl.URL_MESSAGE_DATA), {
        method: "GET",
        headers: {
            "Content-Type": "application/json;charset=utf-8",
            Authorization: `Bearer ${(0, _cookie.getToken)()}`
        }
    });
    return response;
}
...
},{"../token/cookie":"deMq3","../data-url":"hqdS9","@parcel/transformer-js/src/esmodule-helpers.js":"3xDVK"}],"iq8Iq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "scrollLastElem", ()=>scrollLastElem);
var _querySelectorsJs = require("../query-selectors.js");
const { ul } = (0, _querySelectorsJs.querySelectors);
function scrollLastElem() {
    const lastElement = ul?.lastElementChild;
    if (lastElement !== null) lastElement?.scrollIntoView({
        block: "center",
        behavior: "smooth"
    });
}

},{"../query-selectors.js":"fP9pM","@parcel/transformer-js/src/esmodule-helpers.js":"3xDVK"}]},["ciZNZ","ePRIk"], "ePRIk", "parcelRequire94c2")

//# sourceMappingURL=index.ed807707.js.map
